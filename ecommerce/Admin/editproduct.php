                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" name="title" required class="form-control" id="exampleInputName1" placeholder="Title" value="<?= $productDetails['title'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="price">Price</label>
                      <input type="number" required  name="price" class="form-control" id="price" placeholder="Price in PKR" value="<?= $productDetails['price'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="stock">Stock</label>
                      <input type="number" required  name="stock" class="form-control" id="stock" placeholder="Stock" value="<?= $productDetails['stock'] ?>">
                    </div>
...
while($row =mysqli_fetch_assoc($getCategoryResult)){
 ...
 if ( $productDetails['cat_id'] == $cat_id) {
...
?>
                      ...
                      <img src="./uploads/<?= $productDetails['image'] ?>" alt="" height="200">
                      <input type="hidden" name="oldImage" <?= $productDetails['image'] ?>>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="description" id="description" rows="4" value="<?= $productDetails['description'] ?>"><?= $productDetails['description'] ?></textarea>
                    </div>
...
$updateQuery = "UPDATE  `products` SET `title`='$title', `description`='$description', `price`='$price', `stock`='$stock', `image`='$newimgname', `cat_id`='$cat_id' WHERE p_id =$p_id";
